...
{
       0,    17,    17,    20,    21,    23,    24,    26,    27,    28,
      30,    31,    32,    34,    35,    36,    38,    39,    43,    44,
      47,    48
};
#endif
...
{
  "$end", "error", "$undefined", "NAME", "ATT", "ERROR", "LSB", "RSB",
  "EOT", "DQ", "SP", "FO", "FC", "LB", "RB", "SQ", "COMMA", "ANY",
  "ESCDBQ", "ESCSQ", "NL", "_EOF", "EQ", "TEXT", "$accept", "grammar",
  "tags", "attr", "attributes", "attrname", "value", "content", "text",
  "tt", YY_NULLPTR
};
#endif
...
{
     -23,     7,    -3,   -23,    -5,   -23,   -23,    -7,    -2,    -4,
     -23,     8,   -23,    11,    13,   -23,   -23,    -1,   -23,   -23,
      12,     6,    -6,   -23,   -23,   -23,     5,     5,     5,    14,
       9,   -23,   -23,   -23
};
...
{
       4,     0,     0,     1,     6,     2,     9,    19,     0,    21,
       3,     0,    12,     0,     0,     5,     8,    15,    20,    18,
       0,     0,     0,     7,    11,    10,    17,    17,    17,     0,
       0,    16,    14,    13
};
...
{
     -23,   -23,   -23,   -23,   -23,   -23,   -23,   -22,   -23,    16
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,     7,     8,    17,    23,    29,    10,    11
};
...
{
       4,   -21,    12,    26,    13,    30,    31,     3,     6,    27,
       9,    14,    15,     9,    16,    20,    19,    21,     5,    24,
      25,    22,    28,    32,    33,    18
};

static const yytype_uint8 yycheck[] =
{
       3,     8,     4,     9,     6,    27,    28,     0,    13,    15,
      17,    13,    14,    17,    16,     4,     8,     4,    21,     7,
      14,    22,    17,     9,    15,     9
};
...
{
       0,    25,    26,     0,     3,    21,    13,    27,    28,    17,
      32,    33,     4,     6,    13,    14,    16,    29,    33,     8,
       4,     4,    22,    30,     7,    14,     9,    15,    17,    31,
      31,    31,     9,    15
};
